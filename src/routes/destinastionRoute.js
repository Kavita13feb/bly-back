...
destinationRouter.get('/:id', destinationController.getDestination);

// Update destination rating                      
destinationRouter.put('/:id/rating', destinationController.updateRating);

// Search destinations by region
destinationRouter.get('/search/:region', destinationController.searchByRegion);  

// Update destinations from yacht data
destinationRouter.post('/update-from-yachts', destinationController.updateDestinationsFromYachts);   
