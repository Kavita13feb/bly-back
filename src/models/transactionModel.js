...
const TransactionSchema = new mongoose.Schema({
     ...
     ownerId: { type: mongoose.Schema.Types.ObjectId, ref: "BoatOwner" },
     yachtId: { type: mongoose.Schema.Types.ObjectId, ref: "Boat" },
     ...
     txnRef: { type: mongoose.Schema.Types.ObjectId, required: true }, // bookingId or payoutId or paymentId
