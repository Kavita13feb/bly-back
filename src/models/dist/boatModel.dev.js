...
var boatSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    "enum": ["draft", "pending", "published", "archived", "rejected", "approved"],
    "default": "draft"
  },
  isLive: {
    type: Boolean,
  ...
  location: {
    ...
    // Unique Google Place ID (Highly recommended)
    name: {
      type: String
    },
    formattedAddress: {
  ...
  priceDetails: {
    ...
    // Whether a captain is provided
    captainPrice: Number,
    // Additional price for captain service
    currency: {
      code: String,
      symbol: String
    }
  },
  securityAllowance: Number,
...
module.exports = BoatModel; //imortant
