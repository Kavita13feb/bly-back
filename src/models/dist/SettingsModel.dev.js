...
var settingSchema = new mongoose.Schema({
  section: {
    ...
    required: true,
    unique: true,
    "enum": ["general", "ownerManagement", "bookingAndTransaction", "reportsAndAnalytics", "notificationsAndAlerts", "apiAndIntegration", "dataAndPrivacy", "chatSupport"]
  },
  settings: {
    type: mongoose.Schema.Types.Mixed,
    // Flexible nested object per section
    required: true
  },
  locale: {
    type: String,
